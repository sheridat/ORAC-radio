...
class Radio:
	...
	def loadStations(self):
		...
		for fname in dirList:
			...
			# MPD version 0.19 plus does not require extensions such as m3u, pls
	...
	def loadMusic(self):
		...
		directory = "/var/lib/mpd/music/share/"
	...
	# Toggles MPC/MPD play/pause
	def playpauseToggle(self):
		self.execMpcCommand("toggle")
		return
	...
	def restart(self):
        #self.execCommand("/usr/bin/sudo /sbin/shutdown -r now")
		self.execCommand("shutdown -r now")
		return
	...
	def toggleDisplay(self):	
		log.message("radio.class IR key - DisplayToggle punched" , log.DEBUG)
