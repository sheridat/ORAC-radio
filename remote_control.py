...
def listener():
	...
	listener.register('KEY_DISPLAYTOGGLE',handleIRevent)
	listener.register('KEY_DISPLAY_OFF',handleIRevent)
	listener.register('KEY_PLAYPAUSE',handleIRevent)
	listener.register('KEY_STOP',handleIRevent)
